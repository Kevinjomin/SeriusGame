...
public class PlacementManager : MonoBehaviour
{
    ...
    {
        var neighbourVertices = placementGrip.GetAdjacentCellsOfType(position.x, position.z,type);
    ...
    {
        var resultPath = GripSearch.AStarSearch(placementGrip, new Point(startPosition.x, startPosition.z), new Point(endPosition.x, endPosition.z));
    ...
    internal void RemoveAllTemporaryStructures()
    {
        foreach (var structure in temporaryRoadobjects.Values)
        {
            ...
            placementGrip[position.x,position.z] = CellType.Empty;
